...
<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
     ...
     <li class="nav-item dropdown">
        ...
        <div class='jumbotron' id='hello_user'>
	   <h1 class='display-4'>Администрация</h1>
			<hr class='my-4'>
			<a href='administrations/administration_users.php'><button type='button' style='background-color: #5e1b2d;' class='btn btn-secondary' id='write'>Новые пользователи</button></a>
			<a href='profile.php'><button type='button' style='background-color: #3c5d64;' class='btn btn-secondary' id='write'>Обратно в профиль</button>
			</a>
			<a href='administrations/administration_articles.php'><button type='button' style='background-color: #a8297d;' class='btn btn-secondary' id='write'>Предложка статей</button></a>
			<a href='administrations/good_articles.php'><button type='button' style='background-color: #a8297d;' class='btn btn-secondary' id='write'>Принятые статьи</button></a>
